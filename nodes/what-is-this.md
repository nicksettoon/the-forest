...
- This is just another form of social media.
  ...
  - One where you place ideas exactly where you think they belong, tie them to one another the way you see fit, and present the nest to others.
  ...
  - Each website/app on the internet is pretty much just a graph of nodes, linked together.
    ...
    - It obscures your view of the underlying representation of the information.
      ...
      - However, the probability it can be represented as a graph is 1.
- The majority of what I've done here is nothing new under the sun (as per usual).
  - What I think is new is the proposition of sharing with my friends and family my perspectives on life explicitly, in length, and in graph form.
  - A deliberate organization of thought with the purpose of sharing it publicly, directly from the system I use to take notes.
  - A pseudo-non-fiction encyclopedic memoir.
  - More on the knock on effects this idea has had on me in [[the-system]].
