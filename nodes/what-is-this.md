...
- This is just another form of social media.
  ...
  - Every single website/app on the internet are all just graphs of nodes, linked together.
    - The only difference is the user interface of the app.  
    - It obscures your view of the underlying representation of the information.
- What I am proposing here is a system for deliberate organization of thought; sharing the way you see things, directly from the system you use to take notes.
- More on this in [[the-system]]
- Building and sharing these discrete gardens is an exercise I'm sure hundreds of thousands of people could benefit from.
